...
class TestCreateUserUseCase:
    ...
    async def test_create_user_success(
        self, sample_user_create, sample_user_response, mock_user_repository
    ):
    ...
    async def test_create_user_email_already_exists(
        self, sample_user_create, sample_user_entity, mock_user_repository
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_user_email_normalized_to_lowercase(
        self, mock_user_repository, sample_user_response
    ):
    ...
    async def test_create_user_repository_error(
        self, sample_user_create, mock_user_repository
    ):
