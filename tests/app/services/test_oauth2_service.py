...
class TestOAuth2ServiceTokenGeneration:
    ...
    def test_create_token_pair(self, oauth2_service):
        ...
        # Act
        access_token, refresh_token, expires_at = oauth2_service.create_token_pair(email)
...
class TestOAuth2ServiceIntegration:
    ...
    def test_full_auth_flow(self, oauth2_service):
        ...
        access_token_data = oauth2_service.verify_token(access_token, token_type="access")
        
        # 3. Verify refresh token
        refresh_token_data = oauth2_service.verify_token(refresh_token, token_type="refresh")
