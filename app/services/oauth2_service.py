...
class OAuth2Service:
    ...
    def create_access_token(self, data: dict, expires_delta: Optional[timedelta] = None) -> str:
        ...
        if expires_delta:
            ...
            expire = datetime.utcnow() + timedelta(hours=self.settings.jwt_access_token_expire_hours)
    ...
    def create_token_pair(self, email: str) -> Tuple[str, str, datetime]:
        ...
        """
        access_token_expires = timedelta(hours=self.settings.jwt_access_token_expire_hours)
    ...
    def verify_token(self, token: str, token_type: str = "access") -> Optional[TokenData]:
        ...
        try:
            ...
            if token_type_from_payload != token_type:
                logger.warning(f"Token type mismatch: expected {token_type}, got {token_type_from_payload}")
                return None
            ...
            logger.debug(f"Token verified for subject: {sub} (type: {token_type_from_payload})")
            return token_data
